    ...
    <div className='w-full md:h-screen p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
            ...
            <h2 className='py-4'>Know me better!</h2>
            ...
            <p className='py-2 text-gray-600'>Some other this and that and this and that and this and that and this and that</p>
            <p className='py-2 text-gray-600 underline cursor-pointer'>Check out my projects this and that</p>
        </div>
