    ...
    <div id='home' className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
            ...
            <h1 className='py-4 text-gray-700'>Hi, I am 
                <span className='text-[#5651e5]'> Wasi Uddin Bhuyian</span>
            </h1>
            <h1 className='py-4 text-gray-700'>A Web Developer</h1>
            <p className='py-4 text-gray-600 max-w-[70%] m-auto'>
              I am a web developer specializing in building and developing.
              Currently i am working on sharpening my skills with Next.js
            </p>
